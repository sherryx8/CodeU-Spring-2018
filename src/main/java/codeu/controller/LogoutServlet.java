...
public class LogoutServlet extends HttpServlet {
  ...
  /**
   * This function fires when a user submits the logout form. It gets the username and password
   * from the submitted form data, checks that they're valid, and either adds the user to the session
