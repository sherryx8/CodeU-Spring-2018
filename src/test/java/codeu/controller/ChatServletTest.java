...
public class ChatServletTest {
  ...
  public void testDoPost_ModifyMessageColorSize() throws IOException, ServletException{
    ...
    Mockito.when(mockRequest.getParameter("message")).thenReturn("[size=4]glue[/size] [color=green]\\[color=blue]this is blue\\[/color][/color]");
  ...
  public void testDoPost_MessageWithURL() throws IOException, ServletException{
    ...
    Mockito.when(mockRequest.getParameter("message")).thenReturn("Contains a url to http://www.google.com and to http://mail.google.com in the content.");
    ...
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals(
        "Contains a url to <a href = http://www.google.com>http://www.google.com</a> " +
        "and to <a href = http://mail.google.com>http://mail.google.com</a> in the content."
         , messageArgumentCaptor.getValue().getContent());
